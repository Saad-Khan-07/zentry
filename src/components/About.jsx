...
export default function About() {
    ...
    <div id="about" className="min-h-screen w-screen">
        <div className="relative margin-bottom-8 margin-top-38 flex flex-col items-center gap-5">
        ...
        <div className="h-dvh w-screen" id="clip">
            <div className="mask-clip-path about-image" id="mask-clip-path">
